...
warehouse-migration:
	docker exec pipelinerunner yoyo develop --no-config-file --database postgres://root:root@warehouse:5432/finance ./migrations

warehouse-rollback:
	docker exec pipelinerunner yoyo rollback --no-config-file --database postgres://root:root@warehouse:5432/finance ./migrations
